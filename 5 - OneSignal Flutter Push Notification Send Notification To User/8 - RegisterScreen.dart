...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void initState() {
    ...
    // Initial Data
    _nameController.text = "balaji";
    _emailController.text = "balaji@gmail.com";
    _passwordController.text = "balaji";
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  if (_formKey.currentState?.validate() ?? false) {
                    ...
                    Provider.of<Auth>(context, listen: false).registerUser(creds: creds);
